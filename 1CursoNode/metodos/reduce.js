...
// Reduce: (([Acumulador], [Nota]), inicio/valor) -> Reduz todos os elementos de um array a um elemento só, como aqui em que eu peguei todos os elementos de um Array e transformei em uma media